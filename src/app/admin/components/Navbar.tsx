    ...
    <nav className='w-full bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm'>
        <div className='max-w-7xl mx-auto h-16 flex items-center justify-between px-4 sm:px-6'>
          ...
          <div className='flex items-center gap-6 text-sm'>
            <Link className='hover:text-primary transition-colors' href='/restaurants'>Restaurants</Link>
            <Link className='hover:text-primary transition-colors' href='/my-restaurants'>My restaurants</Link>
          </div>
        </div>
    </nav>
  )
